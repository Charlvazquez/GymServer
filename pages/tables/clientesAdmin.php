        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Clientes del GYM</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    require 'conn.php';
                    $consulta = "SELECT Id_Usuario,CONCAT(Nombre, ' ', Apellido) AS nombre_completo,Sexo,Horario FROM usuario WHERE Id_Tipo = 1	;";
                    ...
                    ?>
                     <tr>
                          ...
                          <td> 
                            <button title="Registro de Info cliente" class="btn btn-info success-icon-notika" onclick="redirectMain(<?php echo $cliente['Id_Usuario']; ?>)">
                                <i class="fas fa-user"></i>
                            </button>
                            <button title="Eliminar Cliente" class="btn btn-danger delete-icon" data-membresia="<?php echo $cliente['Id_Usuario']; ?>">
...
function redirectMain(recetaId) {
    ...
    window.location.href = 'datosgenerales.php?id=' + recetaId;
}

// Eliminar cliente
$(document).on('click', '.delete-icon', function() {
    var clienteId = $(this).data('membresia');
