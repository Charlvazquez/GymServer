        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Datos Generales del Cliente</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="datosGenPos.php" method="post">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        require 'conn.php';
                        ?>
                        <input type="hidden" name="cliente" class="form-control" id="cliente" value="<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Nivel</label>
                        <select class="form-control select2bs4" style="width: 100%;" name="nivel">
                            <option value="PRINCIPIANTE" selected="selected">PRINCIPIANTE</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="peso" class="form-control" id="exampleInputEmail1" placeholder="Escribe tu peso">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Altura</label>
                    <input type="text" name="altura" class="form-control" id="exampleInputEmail1" placeholder="Escribe tu altura">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tipo de Sangre</label>
                    <input type="text" name="sangre" class="form-control" id="exampleInputEmail1" placeholder="Escribe tu tipo de sangre">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Seguro Medico</label>
                    <input type="text" name="seguro" class="form-control" id="exampleInputEmail1" placeholder="Escribe tu seguro medico">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Telefono de emergencia</label>
                    <input type="text" name="telefono" class="form-control" id="exampleInputEmail1" placeholder="Escribe tu telefono de emergencia">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Objetivo</label>
                        <select class="form-control select2" style="width: 100%;" name="objetivo">
                            <?php
                            require 'conn.php';
                            ...
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                echo '<option value="' . $row['Id_Objetivo'] . '">' . $row['Nombre'] . '</option>';
                            }
                            ?>
                        </select>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Entrenador</label>
                        <select class="form-control select2" style="width: 100%;" name="entrenador">
                            ...
                            require 'conn.php';
                            // Realizar la consulta a la base de datos
                            $query = "SELECT Id_Usuario,  CONCAT(Nombre, ' ', Apellido) AS nombre_completo FROM usuario where Id_Tipo = 2";
