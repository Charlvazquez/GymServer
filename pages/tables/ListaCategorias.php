            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    require 'conn.php';
                    $consulta = "SELECT * FROM categoria_ejercicios";
                    ...
                    ?>
                     <tr>
                              <td><?php echo $cliente['id_categoria']?> </td>
                              <td><?php echo $cliente['descripcion']?> </td>
                              <td> 
                                <button title="Eliminar Categoria" class="btn btn-danger delete-icon" data-membresia="<?php echo $cliente['id_categoria']; ?>">
...
$(document).on('click', '.delete-icon', function() {
    var categoriaId = $(this).data('membresia');
