          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Registro de Maquinas</h3>
              </div>
              <!-- form start -->
              <form action="MaquinaPos.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nombre de maquina</label>
                    <input type="text" name="maquina" class="form-control" id="exampleInputEmail1" placeholder="Escribe el nombre de maquina">
                  </div>
                  <div class="form-group">
