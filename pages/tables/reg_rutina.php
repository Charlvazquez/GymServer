          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Rutina Semanal</h3>
              </div>
              <!-- form start -->
              <form action="reg_rutinaPos.php" method="post">
                <div class="card-body">
                <div class="form-group">
                    ...
                    require 'conn.php';
                    ?>
                    <input type="hidden" name="cliente_id" class="form-control" id="cliente_id" value="<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>" readonly>
                </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Fecha</label>
                    <input type="date" name="fecha" class="form-control">
                  </div>
                  <div class="form-example-int mg-t-8">
                      <div class="form-group">
                          <div class="nk-int-st">
                            <div id="ingredients_container"></div>
                              <button class="btn btn-warning" type="button" onclick="addIngredient()">Agregar Ejercicio y Repeticion</button>
                          </div>
                      </div>
                  </div>
...
<script>
  function addIngredient() {
      ...
      ingredientSelect.name = 'Id_Ejercicio[]';
      ingredientSelect.required = true;

      fetch('ejerciciosList.php')
        .then(response => response.json())
        .then(ingredients => {
          ingredients.forEach(ingredient => {
            const option = document.createElement('option');
            option.value = ingredient.Id_Ejercicio;
      ...
      defaultOption.value = '';
      defaultOption.text = 'Selecciona un ejercicio';
      ingredientSelect.appendChild(defaultOption);

      container.appendChild(ingredientSelect);

      const quantityInput = document.createElement('input');
      quantityInput.type = 'number';
      quantityInput.name = 'quantity[]';
      quantityInput.placeholder = 'Repeticiones';
      ...
      removeButton.onclick = () => {
        container.removeChild(ingredientSelect);
