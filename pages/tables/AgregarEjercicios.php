          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Registro Ejercicio</h3>
              </div>
              <!-- form start -->
              <form action="ejerciciosPos.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nombre de Ejercicio</label>
                    <input type="text" name="ejercico" class="form-control" id="exampleInputEmail1" placeholder="Escribe el nombre del ejercicio">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Categoria</label>
                        <select class="form-control select2" style="width: 100%;" name="categoria">
                            ...
                            $query = "SELECT * FROM categoria_ejercicios";
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Agregar Video Ejercicio</label>
                    <input type="text" name="video" class="form-control" id="exampleInputEmail1" placeholder="Agregar Video de ejercicio">
                  </div>      
