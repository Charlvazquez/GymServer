  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agregar Imagen Motivacional</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Imagen Motivacional</a></li>
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Imagen Motivacional</h3>
              </div>
              <!-- form start -->
              <form action="ImMovPos.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Agregar Imagen</label>
                    <input type="file" name="imagen" class="form-control" id="exampleInputEmail1" placeholder="Escribe el nombre de la categoria">
                  </div>    
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Guardar Imagen Motivacional</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
