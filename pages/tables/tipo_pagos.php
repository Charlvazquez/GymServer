              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    ...
                    ?>
                     <tr>
                              <td><?php echo $pago['Id_TipoDePago']?> </td>
                              <td><?php echo $pago['Nombre']?> </td>
                              <td> 
                              <button title="Eliminar Pago" class="btn btn-danger delete-icon" data-membresia="<?php echo $pago['Id_TipoDePago']; ?>">
