  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Lista de Maquinas del GYM</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Maquinas</a></li>
              <li class="breadcrumb-item active">Maquinas del GYM</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    require 'conn.php';
                    $consulta = "SELECT a.id_maquina,a.nombre AS maquina,b.descripcion AS categoria FROM lista_maquina AS a 
                    ...
                    ?>
                     <tr>
                              <td><?php echo $cliente['id_maquina']?> </td>
                              <td><?php echo $cliente['maquina']?> </td>
