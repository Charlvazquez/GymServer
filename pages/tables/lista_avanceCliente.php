            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    require 'conn.php';
                    $clienteAvance = intval($_GET['id']);
                    $consulta = "SELECT a.Id_Usuario,a.IMC,a.PesoActual,a.PorcentajeGrasa,a.PesoDeCarga,CONCAT(b.Nombre,' ',b.Apellido) AS nombre_completo,a.Fecha FROM avances AS a
                    LEFT JOIN usuario AS b ON a.Id_Usuario = b.Id_Usuario 
                    WHERE a.Id_Usuario = $clienteAvance;";
                    ...
                    ?>
                     <tr>
                              ...
                              <td><?php echo $cliente['IMC']?> </td>
                              <td><?php echo $cliente['PesoActual']?> </td>
                              <td><?php echo $cliente['PorcentajeGrasa']?> </td>
                              <td><?php echo $cliente['PesoDeCarga']?> </td>
