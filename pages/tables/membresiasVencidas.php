  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Lista de Membresias Vencidas de Clientes</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Membresias</a></li>
              <li class="breadcrumb-item active">Lista de Membresias Vencidas de Clientes del GYM</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    ...
                    a.Horario,
                    d.Descripcion AS membresia,
                    c.FechaVencimiento,
                    CASE 
                        WHEN c.FechaVencimiento = CURDATE() THEN 'POR PAGAR'
                        ELSE 'INACTIVA'
                ...
                WHERE 
                    a.Id_Tipo = 1 
                    AND (c.FechaVencimiento = CURDATE() OR c.FechaVencimiento < CURDATE());";
                    ...
                    ?>
                     <tr>
                              ...
                              <td> 
                                <button title="Renovar Membresia" class="btn btn-info success-icon-notika" onclick="redirectMain(<?php echo $cliente['Id_Usuario']; ?>)">
...
function redirectMain(recetaId) {
    ...
    window.location.href = 'renovarMembresia.php?id=' + recetaId;
}
