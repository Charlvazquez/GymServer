        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="avancePos.php" method="post">
                <div class="card-body">
                ...
                <select class="form-control select2" style="width: 100%;" name="cliente">
                    ...
                    $query = "SELECT a.Id_Usuario, CONCAT(a.Nombre, ' ', a.Apellido) AS nombre_completo
                            FROM Usuario AS a
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Resistencia</label>
                    <input type="text" name="resistencia" class="form-control" id="exampleInputEmail1" placeholder="Resistencia">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Fuerza</label>
                    <input type="text" name="fuerza" class="form-control" id="exampleInputEmail1" placeholder="Fuerza">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Flexibilidad</label>
                    <input type="text" name="flexibilidad" class="form-control" id="exampleInputEmail1" placeholder="Flexibilidad">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Peso</label>
                    <input type="text" name="peso" class="form-control" id="exampleInputEmail1" placeholder="Peso">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Cambios</label>
                    <input type="text" name="cambios" class="form-control" id="exampleInputEmail1" placeholder="Cambios">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">IMC</label>
                    <input type="text" name="imc" class="form-control" id="exampleInputEmail1" placeholder="IMC">
                  </div>
