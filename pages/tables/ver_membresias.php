  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Lista de Membresias de Clientes</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Membresias</a></li>
              <li class="breadcrumb-item active">Lista de Membresias de Clientes del GYM</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    require 'conn.php';
                    $consulta = "SELECT c.Id_Membresia,a.Id_Usuario, CONCAT(a.Nombre, ' ', a.Apellido) AS nombre_completo, a.Horario,d.Descripcion AS membresia, c.Estado AS Estado_Membresia,
                    c.FechaVencimiento
                    FROM Usuario AS a
                    ...
                    WHERE a.Id_Tipo = 1 AND c.FechaVencimiento > CURDATE();";
                    ...
                    ?>
                     <tr>
                              ...
                              <td><?php echo $cliente['Estado_Membresia']?> </td>
                              <td><?php echo $cliente['FechaVencimiento']?> </td>
                              <td> 
                                <button title="Editar Membresia" class="btn btn-info success-icon-notika" onclick="redirectMain(<?php echo $cliente['Id_Usuario']; ?>)">
                                    <i class="fas fa-user"></i>
                                </button>
                                <button title="Eliminar Membresia" class="btn btn-danger delete-icon" data-membresia="<?php echo $cliente['Id_Membresia']; ?>">
...
function redirectMain(recetaId) {
    ...
    window.location.href = 'des_membresia.php?id=' + recetaId;
}

// Eliminar membresia
$(document).on('click', '.delete-icon', function() {
    var membresiaId = $(this).data('membresia');
    if(confirm("¿Estás seguro de que deseas eliminar esta membresía?")) {
        $.ajax({
            url: 'eliminar_membresia.php',
            method: 'POST',
            data: { membresiaId: membresiaId },
