          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Agregar Tipo de Pago</h3>
              </div>
              <!-- form start -->
              <form action="PagoPos.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tipo de Pago</label>
                    <input type="text" name="tipo_pago" class="form-control" id="exampleInputEmail1" placeholder="Escribe el nombre de la categoria">
                  </div>    
