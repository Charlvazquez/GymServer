        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Apartado para Clientes</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <?php
                    ...
                    ?>
                     <tr>
                              ...
                              <td> 
                                <button title="Agregar Rutina" class="btn btn-info success-icon-notika" onclick="redirectMain(<?php echo $cliente['Id_Usuario']; ?>)">
...
function redirectMain(recetaId) {
    ...
    window.location.href = 'reg_rutina.php?id=' + recetaId;
}
