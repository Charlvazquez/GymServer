...
$insertRecipeQuery = "INSERT INTO tipo_pago (Nombre) VALUES (:Nombre)";
...
echo '<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.css">
      ...
      <script>
          jQuery(function(){
            swal({
         title: "¡TIPO DE PAGO AGREGADO CON EXITOSAMENTE!",
         text: "El tipo de pago se agrego con exito",
         type: "success",        
    }, 
    function(){
         window.location.href = "Agregar_TipoPago.php";
    })
          });
       </script>';
?>
