  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Registrar de Membresias</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Registro de membresias</a></li>
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Registro de Membresias</h3>
              </div>
              <!-- form start -->
              <form action="membresiasPos.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="cliente">
                        ...
                        $query = "SELECT Id_Usuario, CONCAT(Nombre,' ',Apellido) AS nombre_completo FROM usuario WHERE Id_Tipo = 1";
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="fecha" class="form-control" id="exampleInputEmail1" placeholder="fecha">
                  </div>  
