  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Avances de Clientes</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Avances</a></li>
              <li class="breadcrumb-item active">Lista de Avances</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    require 'conn.php';
                    $consulta = "SELECT a.Id_Usuario,CONCAT(b.Nombre,' ',b.Apellido) AS nombre_completo,b.Horario,d.descripcion AS membresia,c.Estado AS Estado_Membresia FROM datos_cliente AS a 
                    LEFT JOIN usuario	 AS b ON a.Id_Usuario = b.Id_Usuario
                    LEFT JOIN membresia AS c ON b.Id_Usuario = c.Id_Usuario
                    LEFT JOIN plan_pago AS d ON c.Id_plan = d.Id_Plan
                    WHERE a.Entrenador = $Id_Usuario;";
                    ...
                    ?>
                     <tr>
                              ...
                              <td> 
                                <button title="Revisar Avance" class="btn btn-info success-icon-notika" onclick="redirectMain(<?php echo $cliente['Id_Usuario']; ?>)">
...
function redirectMain(recetaId) {
    ...
    window.location.href = 'lista_avanceCliente.php?id=' + recetaId;
}
